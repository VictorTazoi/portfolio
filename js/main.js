...
function alterarTema(){
    ...
    if(statusTema == 'dark'){
        //Conteudo
        conteudo.classList.remove('fundo-dark');
        conteudo.classList.add('fundo-light');
        //Linha lateral
        ...
        statusTema = 'light';
    }else if(statusTema == 'light'){
        //Conteudo
        conteudo.classList.remove('fundo-light');
        conteudo.classList.add('fundo-dark');
        //Linha lateral
